...
- **Same names as the UI presets** are maintained in **[open-fdd-afdd-stack]( /open-fdd-afdd-stack)** in [`frontend/src/data/brick-1.4-query-class-allowlist.ts`]( /open-fdd-afdd-stack/blob/main/frontend/src/data/brick-1.4-query-class-allowlist.ts) (regression test: [`data-model-testing-queries.brick.test.ts`]( /open-fdd-afdd-stack/blob/main/frontend/src/data/data-model-testing-queries.brick.test.ts)).
