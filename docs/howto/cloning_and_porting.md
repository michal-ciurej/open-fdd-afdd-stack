...
The **open-fdd** repo should be portable to another lab, another workstation, or another Open-FDD deployment with minimal conceptual changes. Optional bench assets live under [`openclaw/README.md`](https://github.com/bbartling/open-fdd-afdd-stack/tree/main/openclaw/README.md).
...
- the test phases (`./scripts/bootstrap.sh --test` in **[open-fdd-afdd-stack](https://github.com/bbartling/open-fdd-afdd-stack)** and optional [`openclaw/bench/e2e/README.md`](https://github.com/bbartling/open-fdd-afdd-stack/tree/main/openclaw/bench/e2e/README.md))
- the BACnet fake-device approach ([`openclaw/bench/fake_bacnet_devices/README.md`](https://github.com/bbartling/open-fdd-afdd-stack/tree/main/openclaw/bench/fake_bacnet_devices/README.md))
- the overnight review discipline
- the SPARQL validation set ([`openclaw/bench/sparql/README.md`](https://github.com/bbartling/open-fdd-afdd-stack/tree/main/openclaw/bench/sparql/README.md))
...
- run the daytime smoke suite first ([`openclaw/bench/e2e/README.md`](https://github.com/bbartling/open-fdd-afdd-stack/tree/main/openclaw/bench/e2e/README.md))
...
2. [`openclaw/README.md`](https://github.com/bbartling/open-fdd-afdd-stack/tree/main/openclaw/README.md)
...
6. [`openclaw/bench/fake_bacnet_devices/README.md`](https://github.com/bbartling/open-fdd-afdd-stack/tree/main/openclaw/bench/fake_bacnet_devices/README.md)
