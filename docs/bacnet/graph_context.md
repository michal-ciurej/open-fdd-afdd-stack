...
Relevant reusable queries live under [`openclaw/bench/sparql/README.md`](https://github.com/bbartling/open-fdd-afdd-stack/tree/main/openclaw/bench/sparql/README.md), especially:
