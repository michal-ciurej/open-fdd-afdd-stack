...
1. **Fake BACnet device schedule is known**
   - use the deterministic schedules in [`openclaw/bench/fake_bacnet_devices/README.md`]( /open-fdd-afdd-stack/tree/main/openclaw/bench/fake_bacnet_devices/README.md)
...
3. **Open-FDD graph confirms BACnet addressing is modeled correctly**
   ...
   - use the SPARQL assets in [`openclaw/bench/sparql/README.md`]( /open-fdd-afdd-stack/tree/main/openclaw/bench/sparql/README.md)
