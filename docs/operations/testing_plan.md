...
This is the evolving engineering plan for Open-FDD automated testing and the optional **OpenClaw lab** bench under [`openclaw/README.md`]( /open-fdd-afdd-stack/tree/main/openclaw/README.md).
...
Or on Windows: [`openclaw/windows/run_daytime_short_suite.cmd`]( /open-fdd-afdd-stack/tree/main/openclaw/windows/run_daytime_short_suite.cmd) (edit URLs first).
